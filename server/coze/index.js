new CozeWebSDK.WebChatClient({
  ...
  */
  auth: {
    type: 'token',
    token: 'pat_drMX4Qduj6NNcrU4WaOU4Pcp4wi9NWhHaetLW1ud3h8Va2z9RelLUrLBIYiKqx5x',
  ...
  */
  userInfo: {
    id: '3137323286157770',
    url: 'https://img2.baidu.com/it/u=600722015,3838115472&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=750',
    nickname: 'User',
  },
  ui: {
    /**
    ...
    */
    base: {
      icon: 'https://img0.baidu.com/it/u=3591665277,2616537962&fm=253&app=138&f=JPEG?w=800&h=1333',
      layout: 'mobile',
      lang: 'en',
      zIndex: 1000
    },
